...
def handle_claim_territory(game: Game, bot_state: BotState, query: QueryClaimTerritory) -> MoveClaimTerritory:
    ...
    if len(my_territories) == 0:
        if len(list(set(unclaimed_territories) & set(continents[5]))) == 4:
            selected_territory = sorted(list(set(unclaimed_territories) & set(continents[5])), key=lambda x: len(game.state.map.get_adjacent_to(x)), reverse=True)[0]
        elif len(list(set(unclaimed_territories) & set(continents[3]))) == 4:
            selected_territory = sorted(list(set(unclaimed_territories) & set(continents[3])), key=lambda x: len(game.state.map.get_adjacent_to(x)), reverse=True)[0]
        elif len(list(set(unclaimed_territories) & set(continents[4]))) == 6:
            selected_territory = sorted(list(set(unclaimed_territories) & set(continents[4])), key=lambda x: len(game.state.map.get_adjacent_to(x)), reverse=True)[0]
        elif len(list(set(unclaimed_territories) & set(continents[0]))) == 9:
            selected_territory = sorted(list(set(unclaimed_territories) & set(continents[0])), key=lambda x: len(game.state.map.get_adjacent_to(x)), reverse=True)[0]
        elif len(list(set(unclaimed_territories) & set(continents[1]))) == 7:
            selected_territory = sorted(list(set(unclaimed_territories) & set(continents[1])), key=lambda x: len(game.state.map.get_adjacent_to(x)), reverse=True)[0]
        else:
        ...
        if len(my_territories) == 1:
            if len(list(set(my_territories) & set(continents[5]))) == 1 & len(list(set(unclaimed_territories) & set(continents[5]))) != 0:
                selected_territory = sorted(list(set(unclaimed_territories) & set(continents[5])), key=lambda x: len(game.state.map.get_adjacent_to(x)), reverse=True)[0]
            elif len(list(set(my_territories) & set(continents[3]))) == 1& len(list(set(unclaimed_territories) & set(continents[3]))) != 0:
                selected_territory = sorted(list(set(unclaimed_territories) & set(continents[3])), key=lambda x: len(game.state.map.get_adjacent_to(x)), reverse=True)[0]
            elif len(list(set(my_territories) & set(continents[4]))) == 1& len(list(set(unclaimed_territories) & set(continents[4]))) != 0:
                selected_territory = sorted(list(set(unclaimed_territories) & set(continents[4])), key=lambda x: len(game.state.map.get_adjacent_to(x)), reverse=True)[0]
            elif len(list(set(my_territories) & set(continents[0]))) == 1& len(list(set(unclaimed_territories) & set(continents[0]))) != 0:
                selected_territory = sorted(list(set(unclaimed_territories) & set(continents[0])), key=lambda x: len(game.state.map.get_adjacent_to(x)), reverse=True)[0]
            elif len(list(set(my_territories) & set(continents[1]))) == 1& len(list(set(unclaimed_territories) & set(continents[1]))) != 0:
                selected_territory = sorted(list(set(unclaimed_territories) & set(continents[1])), key=lambda x: len(game.state.map.get_adjacent_to(x)), reverse=True)[0]
            else:
                selected_territory = sorted(available, key=lambda x: count_adjacent_friendly(x), reverse=True)[0]
    ...
    # Or if there are no such territories, we will pick just an unclaimed one with the greatest degree.
        ...
        if len(list(set(unclaimed_territories) & set(continents[5]))) == 0 & len(list(set(unclaimed_territories) & set(continents[3]))) != 0:
            selected_territory = sorted(list(set(unclaimed_territories) & set(continents[3])), key=lambda x: len(game.state.map.get_adjacent_to(x)), reverse=True)[0]
        elif len(list(set(unclaimed_territories) & set(continents[3]))) == 0 & len(list(set(unclaimed_territories) & set(continents[5]))) != 0:
            selected_territory = sorted(list(set(unclaimed_territories) & set(continents[5])), key=lambda x: len(game.state.map.get_adjacent_to(x)), reverse=True)[0]
        else:
            selected_territory = sorted(unclaimed_territories, key=lambda x: len(game.state.map.get_adjacent_to(x)), reverse=True)[0]
...
def handle_place_initial_troop(game: Game, bot_state: BotState, query: QueryPlaceInitialTroop) -> MovePlaceInitialTroop:
    ...
    if len(list(set(my_territories) & set(continents[5]))) == 4:        
        if 24 in my_territories:
            border_territories.insert(0, 24)
    elif len(list(set(my_territories) & set(continents[5]))) < 4 & len(list(set(my_territories) & set(continents[5]))) > 0: 
        print("I'm going here")
        if len(list(set(my_territories) & set(continents[5]))) == 1:
            return game.move_place_initial_troop(query, 40)
        border_territories = list(set(border_territories) & set(continents[5]))
        border_territory_models = [game.state.territories[x] for x in border_territories]
        min_troops_territory = min(border_territory_models, key=lambda x: x.troops)

        return game.move_place_initial_troop(query, min_troops_territory.territory_id)
    elif len(list(set(my_territories) & set(continents[3]))) == 4:
        border_territory_models = [game.state.territories[29], game.state.territories[30]]
        min_troops_territory = min(border_territory_models, key=lambda x: x.troops)
        return game.move_place_initial_troop(query, min_troops_territory.territory_id)
    elif len(list(set(my_territories) & set(continents[3]))) < 4 & len(list(set(my_territories) & set(continents[3]))) > 0:   
        border_territories = list(set(border_territories) & set(continents[3]))
        border_territory_models = [game.state.territories[x] for x in border_territories]
        min_troops_territory = min(border_territory_models, key=lambda x: x.troops)

        return game.move_place_initial_troop(query, min_troops_territory.territory_id)
    elif len(list(set(my_territories) & set(continents[4]))) == 6:
        border_territory_models = [game.state.territories[34], game.state.territories[36]]
        min_troops_territory = min(border_territory_models, key=lambda x: x.troops)
        return game.move_place_initial_troop(query, min_troops_territory.territory_id)
    elif len(list(set(my_territories) & set(continents[4]))) < 6 & len(list(set(my_territories) & set(continents[4]))) > 0:   
        border_territories = list(set(border_territories) & set(continents[4]))
        border_territory_models = [game.state.territories[x] for x in border_territories]
        min_troops_territory = min(border_territory_models, key=lambda x: x.troops)

        return game.move_place_initial_troop(query, min_troops_territory.territory_id)
    elif len(list(set(my_territories) & set(continents[0]))) == 9:
        border_territory_models = [game.state.territories[0], game.state.territories[2], game.state.territories[4]]
        min_troops_territory = min(border_territory_models, key=lambda x: x.troops)
        return game.move_place_initial_troop(query, min_troops_territory.territory_id)
    elif len(list(set(my_territories) & set(continents[0]))) < 9 & len(list(set(my_territories) & set(continents[0]))) > 0:   
        border_territories = list(set(border_territories) & set(continents[0]))
        border_territory_models = [game.state.territories[x] for x in border_territories]
        min_troops_territory = min(border_territory_models, key=lambda x: x.troops)

        return game.move_place_initial_troop(query, min_troops_territory.territory_id)
    elif len(list(set(my_territories) & set(continents[1]))) == 7:
        border_territory_models = [game.state.territories[13], game.state.territories[10], game.state.territories[14]]
        min_troops_territory = min(border_territory_models, key=lambda x: x.troops)
        return game.move_place_initial_troop(query, min_troops_territory.territory_id)
    elif len(list(set(my_territories) & set(continents[1]))) < 7 & len(list(set(my_territories) & set(continents[1]))) > 0:   
        border_territories = list(set(border_territories) & set(continents[1]))
        border_territory_models = [game.state.territories[x] for x in border_territories]
        min_troops_territory = min(border_territory_models, key=lambda x: x.troops)
...
def handle_distribute_troops(game: Game, bot_state: BotState, query: QueryDistributeTroops) -> MoveDistributeTroops:
    ...
    if len(game.state.recording) < 4000:
        ...
        if(len(list(set(my_territories) & set(continents[5]))) > 0 & len(list(set(my_territories) & set(continents[5]))) != 4 & len(list(set(border_territories) & set(continents[5]))) != 0):
            troops_per_territory = total_troops // len(list(set(border_territories) & set(continents[5])))
            leftover_troops = total_troops % len(list(set(border_territories) & set(continents[5])))
            for territory in list(set(border_territories) & set(continents[5])):
                distributions[territory] += troops_per_territory
        
        elif(len(list(set(my_territories) & set(continents[3]))) > 0 & len(list(set(my_territories) & set(continents[3]))) != 4& len(list(set(border_territories) & set(continents[3]))) != 0):
            troops_per_territory = total_troops // len(list(set(border_territories) & set(continents[3])))
            leftover_troops = total_troops % len(list(set(border_territories) & set(continents[3])))
            for territory in list(set(border_territories) & set(continents[3])):
                distributions[territory] += troops_per_territory
        
        elif(len(list(set(my_territories) & set(continents[4]))) > 0 & len(list(set(my_territories) & set(continents[4]))) != 6 & len(list(set(border_territories) & set(continents[4]))) != 0):
            troops_per_territory = total_troops // len(list(set(border_territories) & set(continents[4])))
            leftover_troops = total_troops % len(list(set(border_territories) & set(continents[4])))
            for territory in list(set(border_territories) & set(continents[4])):
                distributions[territory] += troops_per_territory

        elif(len(list(set(my_territories) & set(continents[0]))) > 0 & len(list(set(my_territories) & set(continents[0]))) != 9 & len(list(set(border_territories) & set(continents[0]))) != 0):
            troops_per_territory = total_troops // len(list(set(border_territories) & set(continents[0])))
            leftover_troops = total_troops % len(list(set(border_territories) & set(continents[0])))
            for territory in list(set(border_territories) & set(continents[0])):
                distributions[territory] += troops_per_territory
        elif(len(list(set(my_territories) & set(continents[1]))) > 0 & len(list(set(my_territories) & set(continents[1]))) != 7 & len(list(set(border_territories) & set(continents[1]))) != 0):
            troops_per_territory = total_troops // len(list(set(border_territories) & set(continents[1])))
            leftover_troops = total_troops % len(list(set(border_territories) & set(continents[1])))
            for territory in list(set(border_territories) & set(continents[1])):
                distributions[territory] += troops_per_territory
        else:
...
def handle_attack(game: Game, bot_state: BotState, query: QueryAttack) -> Union[MoveAttack, MoveAttackPass]:
    ...
    def attack_weakest(territories: list[int]) -> Optional[MoveAttack]:
        ...
        for candidate_target in territories:
            ...
            for candidate_attacker in candidate_attackers:
                if ((game.state.territories[candidate_attacker].troops > (game.state.territories[candidate_target].troops))) |((game.state.territories[candidate_attacker].troops > (game.state.territories[candidate_target].troops))& (game.state.territories[candidate_target].troops == 1)):
    ...
    if len(game.state.recording) < 1000:
        #We change the attack limit so it is more conservative in the early-mid game
        attack_limit = 4
    else:
        #The attack limit is increased in the mid game
        attack_limit = 6


    if len(game.state.recording) < 4000:
        
        if(len(list(set(my_territories) & set(continents[5]))) > 0 & len(list(set(my_territories) & set(continents[5]))) < 4):
            need_continent = True
            move = attack_weakest(list(set(game.state.get_territories_owned_by(enemy)) & set(continents[5])))
            if move != None:
                return move
        
        if(len(list(set(my_territories) & set(continents[3]))) > 0 & len(list(set(my_territories) & set(continents[3]))) < 4):
            need_continent = True
            move = attack_weakest(list(set(game.state.get_territories_owned_by(enemy)) & set(continents[3])))
            if move != None:
                return move
        
        if(len(list(set(my_territories) & set(continents[4]))) > 0 & len(list(set(my_territories) & set(continents[4]))) < 5):
            need_continent = True
            move = attack_weakest(list(set(game.state.get_territories_owned_by(enemy)) & set(continents[4])))
            if move != None:
                return move
        
        if(len(list(set(my_territories) & set(continents[0]))) > 0 & len(list(set(my_territories) & set(continents[0]))) < 9):
            need_continent = True
            move = attack_weakest(list(set(game.state.get_territories_owned_by(enemy)) & set(continents[0])))
            if move != None:
                return move
        
        if(len(list(set(my_territories) & set(continents[1]))) > 0 & len(list(set(my_territories) & set(continents[1]))) < 7):
            need_continent = True
            move = attack_weakest(list(set(game.state.get_territories_owned_by(enemy)) & set(continents[1])))
            if move != None:
                return move
...
def handle_troops_after_attack(game: Game, bot_state: BotState, query: QueryTroopsAfterAttack) -> MoveTroopsAfterAttack:
    ...
    global attacks
    attacks = attacks + 1
    # We will determine how many troops we should move based on what is left

    if game.state.territories[move_attack.attacking_territory].troops == 2:
        return game.move_troops_after_attack(query, 1)
    elif game.state.territories[move_attack.attacking_territory].troops == 3:
        return game.move_troops_after_attack(query, 2)
    elif game.state.territories[move_attack.attacking_territory].troops == 4:
        return game.move_troops_after_attack(query, 3)
    elif game.state.territories[move_attack.attacking_territory].troops< 8:
        return game.move_troops_after_attack(query, 4)
    elif game.state.territories[move_attack.attacking_territory].troops< 10:
        return game.move_troops_after_attack(query, 5)
    elif game.state.territories[move_attack.attacking_territory].troops< 12:
        return game.move_troops_after_attack(query, 6)
    elif game.state.territories[move_attack.attacking_territory].troops< 14:
        return game.move_troops_after_attack(query, 7)
    elif game.state.territories[move_attack.attacking_territory].troops< 16:
        return game.move_troops_after_attack(query, 8)
    elif game.state.territories[move_attack.attacking_territory].troops< 18:
        return game.move_troops_after_attack(query, 9)
    else:
        return game.move_troops_after_attack(query, game.state.territories[move_attack.attacking_territory].troops -10)
